...
// This program takes the input text file "input.txt" and replaces all
// occurences of specific phrases with other specific phrases
// -----------------------------------------------------------------------------------------
...
int main(int argc, char* argv[])
{
    ...
    if (&buffer)  // is true if buffer is not 0
    {
        for (int i = 0; i < strlen(buffer) - 1; i++) {
            int flag = 0;  // this flag variable is 1 if one of the key phrases are found and
                           // replaced, otherwise it is 0
